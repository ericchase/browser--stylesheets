...
const TargetFileExtensions = ['user.css'];

const aTagList: string[] = [];
const walkEntryList: WalkEntry[] = walkSync('.', {
...
const modified: string = original.slice(0, beggining) + aTagList.join('') + original.slice(end);
